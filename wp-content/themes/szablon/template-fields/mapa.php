                        ...
                        <div class="contactAgency__merge">
                            ...
                            <div class="contactAgency__info">
                                <div class="contactAgency__text">
                                    <?php
                                    while ( have_rows( 'kraje' ) ) {
                                    the_row();
                                    $tresc = get_sub_field('panstwo');
                                    ?>
                                    <div class="contactAgency__separated">
                                        <div class="contactAgency__item">
                                            <div class="contactAgency__icon"><img src="<?php echo TEMP_URI;?>/assets/images/icoGlobe.png" alt="pin"></div><span><?php echo $tresc;?></span>
                                        </div>
                            ...
                            <div class="contactAgency__contactInfo">
                                <?php
                                while ( have_rows( 'informacje_biuro' ) ) {
                                the_row();
                                $tresc = get_sub_field('miejsce');
                                ...
                                <div class="contactAgency__contactWrapper">
                                    <div class="contactAgency__worker">
                                        ...
                                        <div class="contactAgency__workerInfo"><span><?php echo $tresc;?></span></div>
                                    </div>
                                    <div class="contactAgency__phone">
                                        ...
                                        <div class="contactAgency__phoneNumber"><a href="tel:+48717572208"><?php echo $telefon;?></a></div>
                                    </div>
                                    <div class="contactAgency__email">
                                        ...
                                        <div class="contactAgency__emailAddress"><a class="negativeHover" href="mailto:biuro@personnelservice.pl"><?php echo $email;?></a></div>
                                    </div>
                                </div>
                                <?php }?>
                            </div>
